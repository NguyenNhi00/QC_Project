...
const  DimensionModel({String? name, double? upperBound, double? lowerBound}) : super(name, upperBound, lowerBound);
...
class AppearanceErrorModel extends AppearanceError{
 const AppearanceErrorModel({String? name}) : super(name);
